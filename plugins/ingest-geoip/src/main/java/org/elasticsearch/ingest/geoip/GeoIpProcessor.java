...
public final class GeoIpProcessor extends AbstractProcessor {
        ...
        for (Property property : this.properties) {
            switch (property) {
                ...
                case AUTONOMOUS_SYSTEM_NUMBER:
                    if (asn != null) {
                        geoData.put("autonomous_system_number", asn);
                    }
                    break;
                case AUTONOMOUS_SYSTEM_ORGANIZATION:
                    if (aso != null) {
                        geoData.put("autonomous_system_organization", aso);
                    }
                    break;
            }
        }
    ...
    public static final class Factory implements Processor.Factory {
        ...
        static final Set<Property> DEFAULT_ASN_PROPERTIES = EnumSet.of(Property.AUTONOMOUS_SYSTEM_NUMBER,
            Property.AUTONOMOUS_SYSTEM_ORGANIZATION);
    ...
    enum Property {
        ...
        static final EnumSet<Property> ALL_ASN_PROPERTIES = EnumSet.of(Property.IP, Property.AUTONOMOUS_SYSTEM_NUMBER,
            Property.AUTONOMOUS_SYSTEM_ORGANIZATION);
